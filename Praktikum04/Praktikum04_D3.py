...
# staticModel: JikaTrue, deteksi hanya terjadi sekali; jika False, setiap frame
...
EYE_AR_THRESHOLD = 0.25         # ambang Eye Aspect Ratio (EAR) untuk menilai mata tertutup
is_closed = False
